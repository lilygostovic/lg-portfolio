...
function App() {
  //todo:: add style={{backgroundImage: background}} to app-body
  return (
      <div className="App-body">
        ...
        <div className='App-subsection'>
          ...
          <div className='App-infoBlock'>
            <p className='App-blockHeader'>Software Engineer Intern - Forget Finance</p>
            ...
            <p className='App-skills'>TypeScript, React Native, PostgreSQL, Postico, Git, Jira, Notion, Figma</p>
          </div>
          <div className='App-infoBlock'>
            <p className='App-blockHeader'>Web Developer - Hack4Impact McGill</p>
            ...
            <p className='App-skills'>TypeScript, React, TypeORM, Jest, Docker, Git, Figma</p>
          </div>
          <div className='App-infoBlock'>
            <p className='App-blockHeader'>Research Assistant - Ryerson University</p>
            ...
            <p className='App-skills'>Python</p>
          </div>
        </div>
        <div className='App-subsection'>
          <p className="App-subsectionHeader">Projects</p>
          <div className='App-infoBlock'>
            <p className='App-blockHeader'>Class Enrollment Utility</p>
            ...
            <p className='App-skills'>Python, Selenium Chrome Driver</p>
          </div>
          <div className='App-infoBlock'>
            <p className='App-blockHeader'>Personal Website</p>
            ...
            <p className='App-skills'>TypeScript, React, HTML, CSS</p>
          </div>
        </div>
